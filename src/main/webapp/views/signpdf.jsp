...
<body>
			<form enctype="multipart/form-data" class="form-signin" action="signwithkey" method="POST" target="_blank">
			<div class="row">
				<div class="col-md-4"><h3>PDF Signing</h3></div>
			</div>
			<div class="row">&nbsp;</div>
			<div class="row">
			...
			<div class="row">&nbsp;</div>
			<div class="row">
				<div class="col-md-4"><b>Please select a certificate file with a key:</b></div>
				<div class="col-md-4"><input name= "certificate" id="certificate" type="file" size="50" /></div>
			</div>
			<div class="row">&nbsp;</div>
			<div class="row">
				<div class="col-md-4"><b>Enter the certificate PIN to sign</b></div>
				<div class="col-md-4"><input name="password" id="password" type="password" /></div>
			</div>
			<div class="row">
				<div class="col-md-4"><input type="submit" class="btn btn-warning btn-margin" value="Sign!"/></div>
			</div>
			<div class="row">&nbsp;</div>
			<div class="row">
